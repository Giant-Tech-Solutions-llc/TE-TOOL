/**
 * Convert the 4 hair-texture portraits for the Quick Quiz Question 02.
 *   /quiz/hair/{straight,wavy,curly,coily}.webp  + blur placeholders
 *
 * Mirrors the Question 01 face-shape pipeline (q94, 1200 cap, 24w blur).
 */
import fs from 'node:fs/promises'
import path from 'node:path'
import sharp from 'sharp'

const SRC = 'C:/Users/Administrator/Downloads/Add a heading (LinkedIn Post) (4)'
const root = path.resolve(import.meta.dirname, '..')
const OUT = path.join(root, 'public', 'quiz', 'hair')
await fs.mkdir(OUT, { recursive: true })

const PLAN = [
  { src: 'Straight Hair.png', out: 'straight' },
  { src: 'Wavy Hair.png',     out: 'wavy'     },
  { src: 'Curly hair.png',    out: 'curly'    },
  { src: 'Coily Hair.png',    out: 'coily'    },
]
...
console.log(`\nDone — ${PLAN.length * 2} files written to /public/quiz/hair/`)
