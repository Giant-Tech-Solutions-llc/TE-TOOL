      ...
      <div className="flex items-end justify-between gap-6 mb-10 pb-6 border-b border-line">
        ...
        <div className="hidden sm:flex items-center gap-2">
          <button
            ...
            className="w-12 h-12 grid place-items-center border border-line text-soft hover:bg-soft hover:text-ink hover:border-soft transition-colors"
          >
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] bg-surface overflow-hidden mb-5">
        ...
        <div className="absolute top-4 right-4 text-[10px] font-medium tracking-[0.32em] uppercase bg-soft text-ink px-2.5 py-1">
          {rec.match_score}%
        </div>
      </div>
      ...
      <div>
        ...
        <details className="group/d">
          <summary className="list-none cursor-pointer flex items-center justify-between border-t border-line pt-4 text-[10px] font-medium tracking-[0.32em] uppercase text-soft hover:text-gold transition-colors">
            <span>Barber brief</span>
            <span aria-hidden="true" className="transition-transform group-open/d:rotate-180">↓</span>
          </summary>
