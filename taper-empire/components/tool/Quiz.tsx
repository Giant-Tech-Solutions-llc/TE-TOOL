    ...
    options: [
      {
        value: 'straight',
        label: 'Straight',
        desc: 'Lies flat, no natural wave',
        image: '/quiz/hair/straight.webp',
        imageBlur: '/quiz/hair/straight-blur.webp',
        imageAlt: 'Straight hair reference portrait',
      },
      {
        value: 'wavy',
        label: 'Wavy',
        desc: 'S-shaped waves, moderate volume',
        image: '/quiz/hair/wavy.webp',
        imageBlur: '/quiz/hair/wavy-blur.webp',
        imageAlt: 'Wavy hair reference portrait',
      },
      {
        value: 'curly',
        label: 'Curly',
        desc: 'Defined springy coils',
        image: '/quiz/hair/curly.webp',
        imageBlur: '/quiz/hair/curly-blur.webp',
        imageAlt: 'Curly hair reference portrait',
      },
      {
        value: 'coily',
        label: 'Coily',
        desc: 'Tight zig-zag or dense coil',
        image: '/quiz/hair/coily.webp',
        imageBlur: '/quiz/hair/coily-blur.webp',
        imageAlt: 'Coily hair reference portrait',
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 'professional',
        label: 'Professional',
        desc: 'Office, meetings, formal settings',
        image: '/quiz/lifestyle/professional.webp',
        imageBlur: '/quiz/lifestyle/professional-blur.webp',
        imageAlt: 'Professional lifestyle reference portrait',
      },
      {
        value: 'casual',
        label: 'Casual',
        desc: 'Relaxed everyday comfort',
        image: '/quiz/lifestyle/casual.webp',
        imageBlur: '/quiz/lifestyle/casual-blur.webp',
        imageAlt: 'Casual lifestyle reference portrait',
      },
      {
        value: 'creative',
        label: 'Creative',
        desc: 'Bold looks, self-expression',
        image: '/quiz/lifestyle/creative.webp',
        imageBlur: '/quiz/lifestyle/creative-blur.webp',
        imageAlt: 'Creative lifestyle reference portrait',
      },
      {
        value: 'athletic',
        label: 'Athletic',
        desc: 'Active, function-first style',
        image: '/quiz/lifestyle/athletic.webp',
        imageBlur: '/quiz/lifestyle/athletic-blur.webp',
        imageAlt: 'Athletic lifestyle reference portrait',
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: 'Teen',
        desc: '13–19',
        image: '/quiz/age/teen.webp',
        imageBlur: '/quiz/age/teen-blur.webp',
        imageAlt: 'Teen age reference portrait',
      },
      {
        value: '20s',
        label: '20s',
        desc: '20–29',
        image: '/quiz/age/20s.webp',
        imageBlur: '/quiz/age/20s-blur.webp',
        imageAlt: '20s age reference portrait',
      },
      {
        value: '30s',
        label: '30s',
        desc: '30–39',
        image: '/quiz/age/30s.webp',
        imageBlur: '/quiz/age/30s-blur.webp',
        imageAlt: '30s age reference portrait',
      },
      {
        value: '40s+',
        label: '40s+',
        desc: '40 and over',
        image: '/quiz/age/40s.webp',
        imageBlur: '/quiz/age/40s-blur.webp',
        imageAlt: '40s+ age reference portrait',
      },
    ],
  },
  {
