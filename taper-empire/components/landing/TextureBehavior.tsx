...
const TEXTURES: Texture[] = [
  {
    ...
    caption: 'Low or mid taper',
    glyph: '─',
    direction: 'Low or mid taper · Directional issues',
    risk: 'Can read flat after bulk removal',
    execution: 'Matte clay, opt for texture',
  },
  {
    key: 'wavy',
    label: 'Wavy',
    ...
    risk: 'Wave pattern collapses without volume',
  ...
  },
  {
    ...
    caption: 'Temple & nape taper',
    glyph: '◜◝',
    direction: 'Temple & nape taper · Shape retention',
  ...
  return (
    ...
    >
      <Cinematic className="section-y">
        ...
        {/* ── Four texture cards ────────────────────────────────── */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5 mb-14 lg:mb-20">
          {TEXTURES.map((t, i) => (
            <motion.div
              key={t.key}
              initial={{ opacity: 0, y: 24 }}
              ...
              className="group/tex"
            >
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg-x border border-line bg-surface2 transition-all duration-500 group-hover/tex:border-lineHover group-hover/tex:shadow-luxury-sm">
                <Image
                  src={t.image}
                  ...
                  placeholder="blur"
                  blurDataURL={t.blur}
                  className="object-cover object-center transition-transform duration-700 ease-lux group-hover/tex:scale-[1.03]"
                />
                <div
                  aria-hidden="true"
                ...
                <div className="absolute inset-x-0 bottom-0 px-4 pb-4">
                  <p className="font-display font-extrabold tracking-[-0.025em] text-soft text-lg lg:text-xl mb-1">
                    {t.label}
                  </p>
        ...
        >
          <div className="hidden lg:grid grid-cols-12 gap-6 px-8 py-5 border-b border-line bg-[rgba(255,255,255,0.02)]">
            ...
            <Th className="col-span-3">03 · Care risk</Th>
          ...
          <div className="divide-y divide-line">
            {TEXTURES.map((t) => (
              ...
              >
                ...
                <Cell className="lg:col-span-3" eyebrow="Care risk">{t.risk}</Cell>
