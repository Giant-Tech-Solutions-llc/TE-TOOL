...
/**
 * Phase Y.2 — Face Geometry chapter (v2 — portrait reference cards).
 *
 * Five face-shape cards (Round / Oval / Square / Diamond / Heart) sit
 * across the top as real portrait references. Beneath them: a structured
...
const FACES: FaceShape[] = [
  {
    ...
    tagline: 'Low taper',
    recommended: 'Low taper · Textured volume',
  ...
  },
  {
    ...
    tagline: 'Mid taper',
    recommended: 'Mid taper · Natural side compression',
  ...
  },
  {
    ...
    tagline: 'Low–mid taper',
    recommended: 'Low–mid taper · Controlled graduation',
  ...
  },
  {
    ...
    tagline: 'Low taper',
    recommended: 'Low taper · Fringe-compatible top',
      ...
      <Cinematic className="section-y">
        ...
        >
          <div className="col-span-12 md:col-span-7">
            <SectionEyebrow className="mb-6">Chapter III — Face Geometry</SectionEyebrow>
          ...
          <div className="col-span-12 md:col-span-4 md:col-start-9 md:pt-4">
            <p className="text-base lg:text-lg text-soft/65 leading-[1.75] max-w-md">
              Every row is engineered to be quotable in a barber chair — not just readable on a
              screen.
            </p>
          </div>
        </motion.div>

        {/* ── Five portrait reference chips ──────────────────────── */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 lg:gap-4 mb-14 lg:mb-20">
          {FACES.map((f, i) => (
            <motion.figure
              key={f.key}
              ...
              className="group/face relative overflow-hidden rounded-lg-x border border-line bg-surface/30 transition-all duration-500 hover:border-lineHover hover:bg-surface/60 hover:-translate-y-1 hover:shadow-luxury-sm"
            >
              <div className="relative aspect-[4/5] overflow-hidden">
                <Image
                  ...
                  placeholder="blur"
                  blurDataURL={f.blur}
                  className="object-cover object-center transition-transform duration-700 ease-lux group-hover/face:scale-[1.04]"
                />
                <div
                  aria-hidden="true"
